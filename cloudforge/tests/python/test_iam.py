...
# The @mock_aws decorator intercepts any boto3 calls made within this function
# and redirects them to the in-memory mock AWS environment instead of the real one.
@mock_aws
